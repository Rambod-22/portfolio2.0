    ...
    return (
        ...
        whileInView={{opacity: 1}}
         transition={{duration:1.5}} 
          className='min-h-screen pt-32 pb-10 flex relative flex-col text-left md:flex-row max-w-full px-10 justify-evenly mx-auto items-center'>
            ...
            <div ref={scrollRef} className='w-full flex space-x-5 overflow-x-scroll overflow-y-visible p-10 snap-x snap-mandatory scrollbar scrollbar-track-gray-400/20 scrollbar-thumb-[#F7AB0A]/80'>
