...
function About({ pageInfo, isVisible }: Props) {
    ...
    md:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center'>
            ...
            <motion.img initial={{x:0, opacity: 0.2}} src={urlFor(pageInfo?.profilePic).url()} transition={{duration: 1.2}} animate={{opacity: 1, x:0}} viewport={{once:true}} className="-mb-20 md:mb-0 flex-shrink-0 w-56 h-56 rounded-full object-cover md:rounded-lg md:w-64 md:h-95 xl:w-[500px] xl:h-[600px]"   />
